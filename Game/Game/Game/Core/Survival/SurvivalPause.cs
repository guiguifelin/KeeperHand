...
namespace Game
{
    public class SurvivalPause
    {
        ...
        // Constructor.
        public SurvivalPause(Texture2D texture)
        {
        ...
        public void Update(Game1 game, GameTime time, Cursor cursor, MouseState mouse)
        {
            if (!loaded || game.MAIN.OPTIONS.STATES.ENABLEDCHANGELANGWINFAIL)
            {
                ...
                menu.AddButton(new Button(Ressources.t_buttonOptions, new Rectangle(926, 383, Ressources.t_buttonOptions.Width, Ressources.t_buttonOptions.Height), game.MAIN.OPTIONS.TEXTMANAGER.SURVIVALRESUME, "RESUME"));
                loaded = true;
